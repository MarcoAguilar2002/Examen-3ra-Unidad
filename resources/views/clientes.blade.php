...
@section('content')
    ...
    <div class="contenedor" style="background-color: rgb(63, 60, 60)">
        <div class="col-md-12">
            <div class="row text-center content-justify align-items-center" style="height: 75px;">
                ...
                <div class="col-md-3">
                    ...
                    <!-- Modal -->
<div class="modal fade @if ($errors->any()) show @endif" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true" style="@if ($errors->any()) display: block; @endif">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="color: black">Complete el siguiente formulario</h5>
                ...
                <form action="{{ route('web.clientes.store') }}" method="POST">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('fono') is-invalid @enderror" id="celular" name="fono" value="{{ old('fono') }}">
                                @error('fono')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" class="btn btn-primary" style="width: 100px">Registrar</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                @foreach ($clientes as $cliente)
                    <tr>
                        ...
                        <td class="d-flex justify-content-center align-items-center">
                            ...
                            <form action="{{ route('web.clientes.destroy', $cliente->id) }}" method="POST" class="form-eliminar" style="display: inline-block;">
                                @csrf 
                                @method('DELETE')
                                <button type="button" class="btn btn-danger btn-sm mx-1" onclick="confirmarEliminacion(this)">
